(function (window, CubeCompact, CubeLite) {
    ...
    CubeMini.fromGreekState = function (state) {
        return CubeMini.fromCubeCompact(new CubeLite(state).toCubeCompact());
    };
    ...
    if (typeof module !== 'undefined' && module.exports) {
        ...
        this.CubeMini = CubeMini;
    }
})(
    this,
    typeof require === 'function' ? require('./cube-compact') : this.CubeCompact,
    typeof require === 'function' ? require('./cube-lite') : this.CubeLite
);
